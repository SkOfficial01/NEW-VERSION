...
'''
    HELP_FED = '''ғᴇᴅᴇʀᴀᴛɪᴏɴ
    ʏᴏᴜ ᴄᴀɴ ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ғᴇᴅᴇʀᴀᴛɪᴏɴ ʙᴀɴ
...
Fᴏʀ Oᴡɴᴇʀ :
 ...
 • /myfeds: Tᴏ ʟɪsᴛ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴs ᴛʜᴀᴛ ʏᴏᴜ ʜᴀᴠᴇ ᴄʀᴇᴀᴛᴇᴅ
 • /fedtransfer <ɴᴇᴡ_ᴏᴡɴᴇʀ> <ғᴇᴅ_ɪᴅ>:Tᴏ ᴛʀᴀɴsғᴇʀ ғᴇᴅ ᴏᴡɴᴇʀsʜɪᴘ ᴛᴏ ᴀɴᴏᴛʜᴇʀ ᴘᴇʀsᴏɴ
 ...
 • /fbroadcast: Bʀᴏᴀᴅᴄᴀsᴛs ᴀ ᴍᴇssᴀɢᴇs ᴛᴏ ᴀʟʟ ɢʀᴏᴜᴘs ᴛʜᴀᴛ ʜᴀᴠᴇ Jᴏɪɴᴇᴅ ʏᴏᴜʀ ғᴇᴅ


Fᴏʀ Fᴇᴅ Aᴅᴍɪɴs

• /fban <ᴜsᴇʀ> <ʀᴇᴀsᴏɴ>: Fᴇᴅ ʙᴀɴs ᴀ ᴜsᴇʀ
 • /sfban : Fʙᴀɴ ᴀ ᴜsᴇʀ ᴡɪᴛʜᴏᴜᴛ sᴇɴᴅɪɴɢ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ ᴛᴏ ᴄʜᴀᴛs
 • /unfban <ᴜsᴇʀ> <ʀᴇᴀsᴏɴ>: Rᴇᴍᴏᴠᴇs ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴀ ғᴇᴅ ʙᴀɴ
 • /sunfban : Uɴғʙᴀɴ ᴀ ᴜsᴇʀ ᴡɪᴛʜᴏᴜᴛ sᴇɴᴅɪɴɢ ᴀ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ
...
• /fedinfo : Iɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /fedamins : Lɪsᴛ ᴛʜᴇ ᴀᴅᴍɪɴs ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /joinfed : Jᴏɪɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ ᴛᴏ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ. A ᴄʜᴀᴛ ᴄᴀɴ ᴏɴʟʏ Jᴏɪɴ ᴏɴᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ. Cʜᴀᴛ ᴏᴡɴᴇʀs ᴏɴʟʏ.
• /leavefed : Lᴇᴀᴠᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ғᴇᴅᴇʀᴀᴛɪᴏɴ. Oɴʟʏ ᴄʜᴀᴛ ᴏᴡɴᴇʀs ᴄᴀɴ ᴅᴏ ᴛʜɪs.
• /fedstat : Gɪᴠᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ʏᴏᴜʀ ʙᴀɴ ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /fedstat <ᴜsᴇʀ ID> : Gɪᴠᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ᴜsᴇʀ's ʙᴀɴ ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /chatfed : Iɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ ɪs ɪɴ
'''
